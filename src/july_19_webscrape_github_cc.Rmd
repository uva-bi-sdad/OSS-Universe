...
```{r}
res <- parse_github_contributions(remDr, "dads2busy/dataplumbr")
```
...
start_time <- Sys.time()
for (slug in slugs) {
  parse_github_contributions(remDr = remDr, slug = slugs) 
  print(slug)
  Sys.sleep(5)
}
end_time <- Sys.time()
