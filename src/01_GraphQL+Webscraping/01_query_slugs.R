###This script create GraphQl queries to collect repo names, owner login names and license during specified peroid of time
...
# There two functions change dates and time to intervals that can be directly put into queries
...
##Specify time period here. Examples:
